...
---
   ...
   ● Сергеев Игорь Дмитриевич:
     ...
     - Исходный код программ в папке c понятным названием (например src, project);
     
     - Тестовые данные в папке test;
     
     - makefile или скрипт командной строки для получения исполняемого файла. Также возможны другие варианты, но нужно расписать как запустить;

     - отчёт в формате pdf. Если есть желание можно загрузить и doc/docx, но pdf должен быть.
